...
def main():
    make_ext(
        "artemis_externals.accumulation_tree.accumulation_tree",
        sources="./artemis_externals/accumulation_tree/accumulation_tree.pyx",
    )
    ...
    setup(
        ...
        install_requires=[],
        description="External dependencies ported for the Artemis ecosystem",
    )


def make_ext(name, sources, quiet=True):
    """
