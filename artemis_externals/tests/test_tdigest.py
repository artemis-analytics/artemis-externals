...
#
#   This module includes code from the TDigest
#
#   Copyright (c) 2015 Cameron Davidson-Pilon
#   See https://github.com/CamDavidsonPilon/tdigest
...
from artemis_externals.accumulation_tree import AccumulationTree
from artemis_externals.tdigest.tdigest import TDigest, Centroid
...
def example_positive_centroids():
    return RBTree(
        [(0.5, Centroid(0.5, 1)), (1.1, Centroid(1.1, 1)), (1.5, Centroid(1.5, 1)),]
    )
